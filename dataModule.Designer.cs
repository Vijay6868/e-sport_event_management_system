namespace week2
{
    partial class dataModule
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ctnESport = new System.Data.OleDb.OleDbConnection();
            this.oleDbInsertCommand1 = new System.Data.OleDb.OleDbCommand();
            this.oleDbUpdateCommand1 = new System.Data.OleDb.OleDbCommand();
            this.oleDbDeleteCommand1 = new System.Data.OleDb.OleDbCommand();
            this.daArenaMaintenance = new System.Data.OleDb.OleDbDataAdapter();
            this.oleDbSelectCommand2 = new System.Data.OleDb.OleDbCommand();
            this.oleDbInsertCommand2 = new System.Data.OleDb.OleDbCommand();
            this.oleDbUpdateCommand2 = new System.Data.OleDb.OleDbCommand();
            this.oleDbDeleteCommand2 = new System.Data.OleDb.OleDbCommand();
            this.daChallengeMaintenance = new System.Data.OleDb.OleDbDataAdapter();
            ...
            this.daEventMaintenance = new System.Data.OleDb.OleDbDataAdapter();
            ...
            this.dsEsport = new week2.dsEsport();
            ((System.ComponentModel.ISupportInitialize)(this.dsEsport)).BeginInit();
            this.SuspendLayout();
            // 
            // oleDbSelectCommand1
            // 
    ...
    "NA\r\nORDER BY ArenaID";
            this.oleDbSelectCommand1.Connection = this.ctnESport;
            // 
            // ctnESport
            // 
            this.ctnESport.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\\Temp\\NZESL.mdb";
            // 
            // oleDbInsertCommand1
            // 
            this.oleDbInsertCommand1.CommandText = "INSERT INTO `ARENA` (`ArenaName`, `StreetAddress`, `Suburb`, `City`, `PhoneNumber" +
    "`) VALUES (?, ?, ?, ?, ?)";
            this.oleDbInsertCommand1.Connection = this.ctnESport;
            ...
            this.oleDbUpdateCommand1.Connection = this.ctnESport;
            ...
            this.oleDbDeleteCommand1.Connection = this.ctnESport;
            ...
            // daArenaMaintenance
            // 
            this.daArenaMaintenance.DeleteCommand = this.oleDbDeleteCommand1;
            this.daArenaMaintenance.InsertCommand = this.oleDbInsertCommand1;
            this.daArenaMaintenance.SelectCommand = this.oleDbSelectCommand1;
            this.daArenaMaintenance.TableMappings.AddRange(new System.Data.Common.DataTableMapping[] {
            ...
            this.daArenaMaintenance.UpdateCommand = this.oleDbUpdateCommand1;
            this.daArenaMaintenance.RowUpdated += new System.Data.OleDb.OleDbRowUpdatedEventHandler(this.daArenaMaintenance_RowUpdated);
            // 
            // oleDbSelectCommand2
            // 
    ...
    "city`) VALUES (?, ?, ?, ?, ?)";
            ...
            this.oleDbUpdateCommand2.Connection = this.ctnESport;
            ...
            this.oleDbDeleteCommand2.Connection = this.ctnESport;
            ...
            new System.Data.OleDb.OleDbParameter("Original_Capacity", System.Data.OleDb.OleDbType.Integer, 0, System.Data.ParameterDirection.Input, false, ((byte)(0)), ((byte)(0)), "Capacity", System.Data.DataRowVersion.Original, null)});
            // 
            // daChallengeMaintenance
            // 
            this.daChallengeMaintenance.DeleteCommand = this.oleDbDeleteCommand2;
            this.daChallengeMaintenance.InsertCommand = this.oleDbInsertCommand2;
            this.daChallengeMaintenance.SelectCommand = this.oleDbSelectCommand2;
            this.daChallengeMaintenance.TableMappings.AddRange(new System.Data.Common.DataTableMapping[] {
            ...
            this.daChallengeMaintenance.UpdateCommand = this.oleDbUpdateCommand2;
            this.daChallengeMaintenance.RowUpdated += new System.Data.OleDb.OleDbRowUpdatedEventHandler(this.daChallengeMaintenance_RowUpdated);
            // 
            // oleDbSelectCommand3
            // 
    ...
    "stName\r\nFROM         COMPETITOR\r\nORDER BY CompetitorID";
            this.oleDbSelectCommand3.Connection = this.ctnESport;
            // 
            // oleDbInsertCommand3
            // 
    ...
    "Address`, `FirstName`) VALUES (?, ?, ?, ?, ?, ?)";
            this.oleDbInsertCommand3.Connection = this.ctnESport;
            ...
            this.oleDbUpdateCommand3.Connection = this.ctnESport;
            ...
            this.oleDbDeleteCommand3.Connection = this.ctnESport;
            ...
            this.daCompetitor.RowUpdated += new System.Data.OleDb.OleDbRowUpdatedEventHandler(this.daCompetitor_RowUpdated_1);
            // 
            // oleDbSelectCommand4
            // 
            this.oleDbSelectCommand4.CommandText = "SELECT   EventID, EventName, ArenaID, Status, Capacity, EventDate\r\nFROM         E" +
    "VENT\r\nORDER BY EventID";
            this.oleDbSelectCommand4.Connection = this.ctnESport;
            // 
            // oleDbInsertCommand4
            // 
            this.oleDbInsertCommand4.CommandText = "INSERT INTO `EVENT` (`EventName`, `ArenaID`, `Status`, `Capacity`, `EventDate`) V" +
    "ALUES (?, ?, ?, ?, ?)";
            this.oleDbInsertCommand4.Connection = this.ctnESport;
            ...
            this.oleDbUpdateCommand4.Connection = this.ctnESport;
            ...
            this.oleDbDeleteCommand4.Connection = this.ctnESport;
            ...
            // daEventMaintenance
            // 
            this.daEventMaintenance.DeleteCommand = this.oleDbDeleteCommand4;
            this.daEventMaintenance.InsertCommand = this.oleDbInsertCommand4;
            this.daEventMaintenance.SelectCommand = this.oleDbSelectCommand4;
            this.daEventMaintenance.TableMappings.AddRange(new System.Data.Common.DataTableMapping[] {
            ...
            this.daEventMaintenance.UpdateCommand = this.oleDbUpdateCommand4;
            this.daEventMaintenance.RowUpdated += new System.Data.OleDb.OleDbRowUpdatedEventHandler(this.daEventMaintenance_RowUpdated);
            // 
            // oleDbSelectCommand5
            // 
            this.oleDbSelectCommand5.CommandText = "SELECT   ChallengeID, CompetitorID, Status\r\nFROM         ENTRY\r\nORDER BY Challeng" +
    "eID, CompetitorID";
            this.oleDbSelectCommand5.Connection = this.ctnESport;
            // 
            // oleDbInsertCommand5
            // 
            this.oleDbInsertCommand5.CommandText = "INSERT INTO `ENTRY` (`ChallengeID`, `CompetitorID`, `Status`) VALUES (?, ?, ?)";
            this.oleDbInsertCommand5.Connection = this.ctnESport;
    ...
    "`Status` = ?)))";
            this.oleDbUpdateCommand5.Connection = this.ctnESport;
    ...
    " 1 AND `Status` IS NULL) OR (`Status` = ?)))";
            this.oleDbDeleteCommand5.Connection = this.ctnESport;
            ...
            // dsEsport
            // 
            this.dsEsport.DataSetName = "dsEsport";
            this.dsEsport.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            // 
            // dataModule
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.dsEsport)).EndInit();
        ...
        public System.Data.OleDb.OleDbConnection ctnESport;
        ...
        public System.Data.OleDb.OleDbDataAdapter daCompetitor;
        private System.Data.OleDb.OleDbCommand oleDbSelectCommand4;
        private System.Data.OleDb.OleDbCommand oleDbInsertCommand4;
        private System.Data.OleDb.OleDbCommand oleDbUpdateCommand4;
        private System.Data.OleDb.OleDbCommand oleDbDeleteCommand4;
        public System.Data.OleDb.OleDbDataAdapter daEventMaintenance;
        ...
        public System.Data.OleDb.OleDbDataAdapter daEntry;
        public System.Data.OleDb.OleDbDataAdapter daArenaMaintenance;
        public System.Data.OleDb.OleDbDataAdapter daChallengeMaintenance;
        public dsEsport dsEsport;
    }
}